        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <table>
                    <tbody>
                        <tr>
                            <td class="col-md-4 col-form-label text-md-right"><button type="text" id="btnFiterSubmitSearch" class="btn btn-info">Submit</button></td>
                            <td class="col-md-4 col-form-label text-md-right">Desde:</label></td>
        ...
        $(document).ready(function(){
            ...
            // initializing Datatable
                var table = $("#solicitudes-table").DataTable({
                    ...
                    pageLength: 10,
                    ajax: { 
                        url: '{!! route('datatables.solicituds') !!}',
                        type: 'GET',
                        data: function (d) {
                ...
                $('#btnFiterSubmitSearch').click(function(){
                    $('#solicitudes-table').DataTable().draw(true);
                });
