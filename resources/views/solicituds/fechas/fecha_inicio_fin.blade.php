...
<form id="formAgregarCliente" method="POST" action="{{ route('solicituds.updatefechasiniciofin', $solicitud->id) }}">
    @method('PUT')
    @csrf
                ...
                <div class="card shadow mb-4">
                    ...
                    <!-- Card Header - Accordion -->
                        <a href="#collapseCardExampl" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                            <h6 class="m-0 font-weight-bold text-primary">Asignacion de Fechas de la solicitud:
                        ...
                        <div class="collapse show" id="collapseCardExample">
                            <div class="card-body">
                                <div class="text-center">
                                    <em>Por favor, seleccione las fechas de inicio y de fin de la solicitud<br><br></em>
                                </div>
