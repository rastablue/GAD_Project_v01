...
<form id="formAgregarCliente" method="GET" action="{{ route('solicituds.reporteselectapply') }}">
    @csrf
                                ...
                                <!-- Radio buttons -->
                                    <div class="my-3">
                                        ...
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label" for="customRadio2">Solicitudes aprobadas</label>
                                        </div>
                                        <div class="custom-control custom-radio">
