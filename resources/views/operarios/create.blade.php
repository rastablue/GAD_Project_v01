...
@section('content')
<form id="formSolicitud" method="POST" action="{{ route('operarios.store') }}" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card shadow mb-4">
                    <!-- Card Header - Accordion -->
                        <a href="" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                            <h6 class="m-0 font-weight-bold text-primary">Agregar Operario</h6>
                        </a>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="tipo_contrato" class="form-control @error('tipo_contrato') is-invalid @enderror" name="tipo_contrato">
                                                <option value="{{ old('tipo_contrato') }}" selected='true'>{{ old('tipo_contrato') }}</option>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="tipo_licencia" class="form-control @error('tipo_licencia') is-invalid @enderror" name="tipo_licencia">
                                                <option value="{{ old('tipo_licencia') }}" selected='true'>{{ old('tipo_licencia') }}</option>
