...
@section('content')
<form id="formSolicitud" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card shadow mb-4">
                    <!-- Card Header - Accordion -->
                        <a href="" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                            <h6 class="m-0 font-weight-bold text-primary">Agregar Funcionario</h6>
                        </a>
