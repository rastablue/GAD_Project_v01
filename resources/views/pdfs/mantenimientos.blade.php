...
@section('content')
<br><br>
<h5><b> Mantenimiento del vehiculo: </b></h5>{{ $mantenimiento->maquinarias->codigo_nro_gad }} <br><br><br>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td scope="col" colspan="3" style="font-size: 8"> <br>{{ $mantenimiento->observacion }} <br><br></td>
        </tr>
        <tr>
            <th scope="col" style="font-size: 9"><div class="text-center font-weight-bold text-info">Diagnostico:</th>
            <td scope="col" colspan="3" style="font-size: 8"> {{ $mantenimiento->diagnostico }} <br><br></td>
        </tr>
    </tbody>
</table>
...
<h4 class="font-weight-bold text-success mt-5"><b> Vehiculo</b></h4>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <br><br>
            <th scope="col" style="font-size: 9"><div class="text-center font-weight-bold text-info"><br>Observaciones:</th>
            <td scope="col" colspan="3" style="font-size: 8"><br>{{ $mantenimiento->maquinarias->observacion }}</td>
        </tr>
    </tbody>
</table>
