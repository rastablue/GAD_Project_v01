                                            ...
                                            <div class="card-body">
                                                ...
                                                {{-- Cedula --}}
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input id="codigo" type="text" pattern="{9}" class="form-control" disabled value="{{ $maquinaria->operarios->cedula }}" name="codigo" required autocomplete="Codigo" autofocus>
                                                                </div>
                                                            </div>
                                                ...
                                                {{-- Nombre--}}
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="codigo" type="text" pattern="{9}" class="form-control" disabled value="{{ $maquinaria->operarios->name }} {{ $maquinaria->operarios->apellido_pater }} {{ $maquinaria->operarios->apellido_mater }}" name="codigo" required autocomplete="Codigo" autofocus>
                                                                    </div>
                                                                </div>
                                                ...
                                                {{-- Telefono --}}
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="tlf" type="text" pattern="[0-9]{7,10}" class="form-control" disabled value="{{ $maquinaria->operarios->tlf }}" name="tlf" required autofocus>
                                                                    </div>
                                                                </div>
                                                ...
                                                {{-- Tipo Contrato --}}
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="tlf" type="text" pattern="[0-9]{7,10}" class="form-control" disabled value="{{ $maquinaria->operarios->tipo_contrato }}" name="tlf" required autofocus>
                                                                    </div>
                                                                </div>
                                                ...
                                                {{-- Tipo Contrato --}}
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="tlf" type="text" pattern="[0-9]{7,10}" class="form-control" disabled value="{{ $maquinaria->operarios->tipo_licencia }}" name="tlf" required autofocus>
                                                                    </div>
                                                                </div>
