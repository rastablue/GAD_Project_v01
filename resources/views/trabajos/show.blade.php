                                                        ...
                                                        {{-- btn--}}
                                                            <div class="form-group row mb-0">
                                                                <div class="col-md-6 offset-md-5">
                                                                    ...
                                                                    @endcan
                                                                    @can('trabajos.show')
                                                                        <a href="{{ route('trabajos.destroy', Hashids::encode($item->id)) }}" class="btn btn-sm btn-danger">
                                                                            <i class="fas fa-fw fa-eye"></i>
                                                                            Eliminar
                                                                        </a>
                                                                    @endcan
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            @if ($mantenimiento->path)
                                <img class="img-responsive img-rounded float-left" src="{{ $mantenimiento->url_path }}" alt="Imagen de la ficha {{ $mantenimiento->codigo }}">
                            @else
